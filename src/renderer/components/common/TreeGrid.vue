          ...
          <th v-for="(column,index) in cloneColumns" :key="column.key">
            ...
            <label v-else>
              ...
              <span class="ivu-table-sort" v-if="column.sortable" >
                <i class="el-icon-caret-up" :class="{on: column._sortType === 'asc'}" @click.native="handleSort(index, 'asc')"></i>
                <i class="el-icon-caret-bottom" :class="{on: column._sortType === 'desc'}" @click.native="handleSort(index, 'desc')"></i>
              </span>
            </label>
          </th>
        </tr>
            ...
            <div v-if="column.type === 'action'">
              <template v-for="action in (column.actions)">
                <el-button
                  ...
                  v-if="(item.children && action.text!=='删除') || !item.children"
                  :key="action.text"
